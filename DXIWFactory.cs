...
{
    public class DXIWFactory : IComponentFactory
    {
        ...
        {
            get { return "Automates loading ramoval for Deus Ex: Invisible War."; }
        }
        ...
        {
            get { return "https://raw.githubusercontent.com/SuiMachine/LiveSplit.DXIW/master/"; }
        }
        ...
        {
            get { return this.UpdateURL + "Components/update.LiveSplit.DXIW.xml"; }
        }
    }
